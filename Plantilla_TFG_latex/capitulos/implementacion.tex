...
\begin{figure}[H]
    \includegraphics[width=\textwidth]{imagenes/camera/cam-top.png}
    \caption{Perspectiva cenital.}
    \label{fig:cenital}
\end{figure}

\begin{figure}[H]
    \includegraphics[width=\textwidth]{imagenes/camera/cam-frontal.png}
    \caption{Perspectiva frontal del vehículo.}
    \label{fig:frontal}
\end{figure}

\begin{figure}[H]
    \includegraphics[width=\textwidth]{imagenes/camera/cam-pers.png}
