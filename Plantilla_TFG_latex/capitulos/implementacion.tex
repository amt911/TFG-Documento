...
\begin{figure}[H]
\centering
\includegraphics[width=0.83\textwidth]{imagenes/PID-BP.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{imagenes/ruleta.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{imagenes/rutaAStar.png}
...
\begin{itemize}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\textwidth]{imagenes/nodo.png}
    ...
    Este actor (véase sección \ref{sec:terminosunreal}) incluye los métodos necesarios para poder direccionar un nodo de la malla como una matriz (con filas y columnas), poder obtener su posición en coordenadas del mundo y poder convertir de coordenadas del mundo a coordenadas de matriz.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{imagenes/checkpoints.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{imagenes/overtake.png}
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.7\textwidth]{imagenes/trazadoFinal.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{imagenes/pista/uv-straight.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{imagenes/pista/uv-kerb.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{imagenes/barrier/barrierHP.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{imagenes/barrier/barrierNormal.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{imagenes/barrier/barrierfence.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{imagenes/cesped.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{imagenes/arboles.png}
...
\begin{figure}[H]
    \centering
    % \includegraphics[width=\textwidth]{imagenes/trazado.png}
    \includegraphics[width=0.4\textwidth]{imagenes/Ground037_1K_Color.png}
...
\begin{figure}[H]
    \centering
    % \includegraphics[width=\textwidth]{imagenes/trazado.png}
    \includegraphics[width=0.4\textwidth]{imagenes/coast_sand_rocks_02_diff_4k.png}
