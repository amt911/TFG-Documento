...
\begin{itemize}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\textwidth]{imagenes/nodesCropped.png}
...
\begin{figure}[H]
    \centering
    % \includegraphics[width=\textwidth]{imagenes/trazado.jpg}
    \includegraphics[width=0.4\textwidth]{imagenes/cespedTextFinal.png}
...
\begin{figure}[H]
    \centering
    % \includegraphics[width=\textwidth]{imagenes/trazado.jpg}
    \includegraphics[width=0.5\textwidth]{imagenes/sueloTextFinal.png}
