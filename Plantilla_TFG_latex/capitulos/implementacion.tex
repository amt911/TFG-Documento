...
\lstinputlisting[language=C++, caption={Implementación en C++ del controlador PID}, label={fig:pidbp}]{snippets/PID.cpp}

% \begin{lstlisting}[language=C++, caption={Implementación en C++ del controlador PID}]
% asdasdasd
% \end{lstlisting}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{imagenes/converted/raycast.jpg}
