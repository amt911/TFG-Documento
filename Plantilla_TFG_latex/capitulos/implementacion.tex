...
\begin{itemize}
    ...
    \begin{figure}[H]
        ...
        \caption{Visualización de varios nodos en el mapa. Cada nodo es representado por cuatro cuadrados (es la representación de un cubo en Unreal).}
        \label{fig:nodo}
    \end{figure}
...
% Cuando el último coche pasa por línea de meta, aparece una tabla con los resultados de la carrera. La implementación de esta funcionalidad la he hecho comenzando con un array de los vehículos vacío, y conforme llegan a la meta se van introduciendo en dicho array, de forma que cuando llegue el último aparezca la tabla con las mismas posiciones que las que hay en el array.
...
\begin{figure}[H]
	...
	\begin{subfigure}[t]{0.48\textwidth}
	    \centering
        \includegraphics[width=\textwidth,cframe=black 0.5pt 0pt]{imagenes/converted/pista/Asphalt024A_2K_Color.jpg}
	...
	\begin{subfigure}[t]{0.48\textwidth}
	    \centering
	    \includegraphics[width=\textwidth,cframe=black 0.5pt 0pt]{imagenes/converted/pista/Asphalt024A_2K_Color_FinishLineFinal.jpg}
