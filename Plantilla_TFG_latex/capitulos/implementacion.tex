...
% Para ello, he utilizado el plugin ``File System Library''\cite{plugin-dialog}, creado por Lambda Works, para poder abrir las ventanas de diálogo de Windows mediante \textit{blueprints}.
