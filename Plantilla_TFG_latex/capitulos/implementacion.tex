...
\begin{itemize}
    ...
    \begin{figure}[H]
        ...
        \caption{Visualización de varios nodos en el mapa. Cada nodo es representado por cuatro cuadrados (es la representación de un cubo de Unreal).}
        \label{fig:nodo}
    \end{figure}
...
En la figura \ref{fig:sueloFinal} se puede observar el resultado final:
