...
\begin{adjustbox}{angle=90}
    \resizebox{\textheight}{!}{
        \begin{ganttchart}[
                ...
                x unit=5mm,
                time slot format=isodate,
            ]{2023-04-19}{2023-06-18}
            % \gantttitle{Diagrama de Gantt general}{1}
            \gantttitlecalendar{month=name, day, week, weekday=letter} \\
            \ganttbar{Documentación}{2023-04-19}{2023-06-18}
            \ganttnewline[thick, red]
            \ganttgroup{Sprint 5}{2023-04-19}{2023-05-03} \\
            \ganttbar{HU2}{2023-04-19}{2023-04-28}
            \ganttbar{}{2023-05-01}{2023-05-03} \\
            \ganttnewline[thick, red]
            \ganttgroup{Sprint 6}{2023-05-03}{2023-05-17} \\
            \ganttbar{HU4}{2023-05-03}{2023-05-03} \\
            \ganttbar{HU5}{2023-05-03}{2023-05-03} \\
            \ganttnewline[thick, red]
