...
\begin{table}[H]
    \begin{tabularx}{\textwidth}{| X | X | X |}
        \hline
        \multicolumn{1}{|l|}{\textbf{Identificador:} HU15} & \multicolumn{2}{l|}{Utilización del rebufo.}
        \\ \hline
...
\begin{table}[H]
    \begin{tabularx}{\textwidth}{| X | X | X |}
        \hline
        \multicolumn{1}{|l|}{\textbf{Identificador:} HU16} & \multicolumn{2}{l|}{Cambio de la cámara.}
        \\ \hline
...
\begin{table}[H]
    \begin{tabularx}{\textwidth}{| X | X | X |}
        \hline
        \multicolumn{1}{|l|}{\textbf{Identificador:} HU17} & \multicolumn{2}{l|}{Visualización de las rutas.}
        \\ \hline
...
\begin{table}[H]
    \begin{tabularx}{\textwidth}{| X | X | X |}
        \hline
        \multicolumn{1}{|l|}{\textbf{Identificador:} HU18} & \multicolumn{2}{l|}{Visualización de los puntos de control.}
        \\ \hline
