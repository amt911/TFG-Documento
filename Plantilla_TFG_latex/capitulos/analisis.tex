...
%     \begin{tabularx}{\textwidth}{| X | X | X |}
%         \hline
%         \multicolumn{1}{|l|}{\textbf{Identificador:} HU14} & \multicolumn{2}{l|}{Salida de la aplicación.}
%         \\ \hline
%         \multicolumn{3}{|>{\hsize=\dimexpr3\hsize+4\tabcolsep+2\arrayrulewidth\relax\linewidth=\hsize}X|}{\textbf{Descripción:} Como usuario, quiero salir de la aplicación.}
%         \\ \hline
%         \textbf{Estimación:} 0,5 & \textbf{Prioridad:} 5 & \textbf{Entrega:} 8
%         \\ \hline
%         \multicolumn{3}{|>{\hsize=\dimexpr3\hsize+4\tabcolsep+2\arrayrulewidth\relax\linewidth=\hsize}X|}{\textbf{Tareas:}
%         \begin{itemize}
%             \item Incluir el botón en la interfaz.
%             \item Implementar la lógica relacionada con el botón para poder salir de la aplicación.
%         \end{itemize}
%         }
%         \\ \hline
%         \multicolumn{3}{|>{\hsize=\dimexpr3\hsize+4\tabcolsep+2\arrayrulewidth\relax\linewidth=\hsize}X|}{\textbf{Requisitos relacionados:} RNF2.}
%         \\ \hline
%         \multicolumn{3}{|>{\hsize=\dimexpr3\hsize+4\tabcolsep+2\arrayrulewidth\relax\linewidth=\hsize}X|}{\textbf{Pruebas de aceptación:}
%         \begin{itemize}
%             \item Al pulsar el botón, debe salir de la aplicación.
%         \end{itemize}
%         }
%         \\ \hline
%         \multicolumn{3}{|>{\hsize=\dimexpr3\hsize+4\tabcolsep+2\arrayrulewidth\relax\linewidth=\hsize}X|}{\textbf{Observaciones:}}
