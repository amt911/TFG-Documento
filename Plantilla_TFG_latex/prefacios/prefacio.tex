...
%\vspace{0.7cm}
\noindent{\textbf{Palabras clave}: unreal, simulador, ia, }\\
...
% realizando una simulación de las condiciones de cada piloto, permitiendo así que puedan tomar decisiones de manera más realista y que cometan errores en función de como se encuentre. El simulador va a permitir modificar diversos parámetros tanto antes de la carrera, como pueden ser: el número de coches, velocidad máxima de los mismos o habilidad de los pilotos, como durante la carrera en tiempo real (modificación de las condiciones actuales de cada piloto). 
\cleardoublepage
...
Yo, \textbf{Andrés Merlo Trujillo}, alumno de la titulación TITULACIÓN de la \textbf{Escuela Técnica Superior
...
D. \textbf{Luis López Escudero}, Profesor del Área de XXXX del Departamento LSI de la Universidad de Granada.
...
\noindent \textbf{Andrés Merlo Trujillo }%\ \ \ \ \ Nombre Apellido1 Apellido2 (tutor2)}
