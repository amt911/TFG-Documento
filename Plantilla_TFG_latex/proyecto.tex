...
\begin{itemize}
   ...
   \item Mediante reglas: Otra forma de resolver este problemas es mediante reglas, que como su nombre indican, son un conjunto de reglas que se accionarán cuando se dé la condición deseada y normalmente están priorizados. Suelen tener forma de árbol, al hacer preguntas en cadena hasta llegar con la solución.
